...
public class HalamanMinuman extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.activity_halaman_minuman, container, false);
    }
    ...
    private void loadMinuman() {
        ...
        Call<ProdukResponse> userCall = service.getMinuman();
